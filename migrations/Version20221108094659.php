 ...
 */
final class Version20221108094659 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE invoice_lines (id INT AUTO_INCREMENT NOT NULL, invoice_id INT DEFAULT NULL, description VARCHAR(255) NOT NULL, quantity INT NOT NULL, amount DOUBLE PRECISION NOT NULL, vat_amount DOUBLE PRECISION NOT NULL, total_with_vat DOUBLE PRECISION NOT NULL, INDEX IDX_72DBDC232989F1FD (invoice_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
